...
'id' INTEGER,
'relvar_A' INTEGER, FOREIGN KEY(A) REFERENCES A_A(id),
FOREIGN KEY(relvar_A) REFERENCES relvar_A(id));
INSERT INTO "A" VALUES(0,114425483921,286206891609);
CREATE TABLE 'A_A' ('a' INTEGER,
'b' TEXT,
'id' INTEGER);
INSERT INTO "A_A" VALUES(1,'b',0);
CREATE TABLE 'relvar_A' ('id' INTEGER);
INSERT INTO "relvar_A" VALUES(286206891609);
COMMIT;"""
